<?php
    ...
    // --- 2. LOGIKA PENCARIAN CANGGIH (SMART SEARCH) ---
    // Kita pakai Array untuk menampung semua filter
    $where_conditions = [];
    ...
    if (!empty($keyword)) {
        // Pecah keyword berdasarkan spasi. 
        // Contoh: "pandu akuntansi" menjadi ["pandu", "akuntansi"]
        $words = explode(" ", $keyword);
        
        foreach ($words as $word) {
            $safe_word = mysqli_real_escape_string($conn, $word);
            // Setiap kata HARUS ada di salah satu kolom (Nama ATAU NIM ATAU Prodi)
            // Ini membuat pencarian jadi spesifik.
    ...
    // Simpan query pagination terpisah biar rapi
...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; font-family: "Poppins", sans-serif; }
    ...
    /* --- STYLE HEADER & CARD (SAMA SEPERTI SEBELUMNYA) --- */
    ...
    .filter-form {
        ...
        flex-wrap: wrap;
        gap: 15px;
        align-items: end; /* Biar tombol sejajar bawah */
    }
    ...
    @media (max-width: 768px) {
        .input-search { width: 100%; } /* Search full width di HP */
    }
  </style>
</head>
<body>
...
<section class="management">
        ...
        <form method="GET" class="filter-form">
            ...
            <div class="form-group" style="flex-grow: 1;">
                ...
                <input type="text" name="keyword" class="input-search" 
                       placeholder="Contoh: Pandu Komputerisasi Akuntansi" 
    ...
    <table>
        ...
        <tbody>
            <?php 
                // Hitung Total Data untuk Pagination (Query Count)
                // Kita gunakan $sql_where yang sama agar paginasinya sinkron dengan hasil search
            ...
            <?php if(mysqli_num_rows($result) == 0) { ?>
                <tr>
                    <td colspan="8" style="text-align:center; padding: 40px; color:#a0aec0;">
                        Tidak ada data ditemukan untuk pencarian: <b><?= htmlspecialchars($keyword) ?></b>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
    ...
    <div style="display:flex; justify-content:space-between; align-items:center; margin-top:20px; flex-wrap:wrap;">
        ...
        <?php 
            // Parameter URL untuk pagination (biar search gak ilang pas klik Next)
